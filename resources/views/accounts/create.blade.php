<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nueva cuenta</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="post" action="{{ route('cuentas.store') }}" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="currency" name="currency" type="text" class="mt-1 block w-full" :value="old('currency', 'MXN')" required maxlength="8" />
